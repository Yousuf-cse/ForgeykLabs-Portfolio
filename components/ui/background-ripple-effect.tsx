      ...
      {cells.map((idx) => {
        ...
        return (
          <div
            key={idx}
            className={cn(
              "cell relative border-[0.5px] opacity-40 transition-all duration-300 will-change-transform hover:opacity-100 hover:scale-105 hover:bg-[#7A7FEE]/30 hover:border-[#7A7FEE] hover:shadow-[0px_0px_30px_2px_rgba(122,127,238,0.4)] dark:shadow-[0px_0px_40px_1px_var(--cell-shadow-color)_inset] dark:hover:shadow-[0px_0px_60px_3px_#7A7FEE_inset]",
