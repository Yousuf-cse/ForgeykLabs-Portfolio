      ...
      >
        ...
        <div className="w-full max-w-4xl text-center">
          ...
          >
            ...
            marketplaces, and custom web applications with fully hand-crafted
            code and no shortcuts
          </motion.p>
          <motion.div
            variants={fadeInUp}
          ...
          >
            ...
            <a
              href="#services"
              className="btn-secondary text-black dark:text-white hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors duration-200 px-6 py-3 rounded-lg"
            >
              Learn more
            </a>
          </motion.div>
